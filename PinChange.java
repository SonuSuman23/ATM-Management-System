...
public class PinChange extends JFrame implements ActionListener{
    ...
    PinChange(String pinnumber){
        ...
        pintext.setBounds(200,130,180,25);
        image.add(pintext);

        pin = new JPasswordField();
        pin.setFont(new Font("Raleway", Font.BOLD,16));
        pin.setBounds(370, 130, 200,25);
        image.add(pin);
        
        JLabel repintext = new JLabel("Re-Enter Your PIN:");
        repintext.setForeground(Color.BLACK);
        repintext.setFont(new Font("System",Font.BOLD,16));
        repintext.setBounds(200, 160,180,25);
        image.add(repintext);
        
        repin = new JPasswordField();
        repin.setFont(new Font("Raleway", Font.BOLD,16));
        repin.setBounds(370, 160, 180, 25);
        image.add(repin);
        
        change = new JButton("CHANGE");
        change.setBounds(400,310,150,30);
